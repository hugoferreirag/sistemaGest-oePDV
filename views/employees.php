...
<div>
<button type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-sm">Novo Funcionário</button><hr>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
          <span aria-hidden="true">&times;</span>
			 ...
			 <div class="modal-body">
						<form class="form" action="<?php echo BASE_URL; ?>employees/newEmployeer" method="post">
    ...
    <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
          <span aria-hidden="true">&times;</span>
			...
			<div class="modal-body	">
     <form class="form"action="<?php echo BASE_URL; ?>employees/edit" method="post">
		...
		<label for="Salario">Salario</label><br>
		<input id="salario" type="text" name="salario"><br>
		</div>
		<div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
        <button type="submit" class="btn btn-success">Salvar mudanças</button>
...
<script>
function editar(id, nome, cpf, rua, bairro, cidade, salario){
	$('#modal2').modal('show');
	var id = id;
	var cpf = cpf;
	$('#id').val(id);
